...
router.post(
  "/discounts",
  restrictTo(Role.admin),
  DiscountsController.addDiscount,
);
router.get(
  "/discounts",
  restrictTo(Role.admin, Role.staff),
...
router.post(
  "/batches/receive",
  restrictTo(Role.admin, Role.staff),
  BatchesController.receiveStock,
);
router.delete(
  "/batches/:id",
  restrictTo(Role.admin),
...
router.get(
  "/supplier-orders/recent",
  restrictTo(Role.admin, Role.staff),
  BatchesController.getRecentSupplierOrders,
);
router.get(
  "/supplier-orders/:id/pdf",
  restrictTo(Role.admin, Role.staff),
  BatchesController.getPurchaseOrderPdf,
);
...
router.get(
  "/adjustments",
  restrictTo(Role.admin, Role.staff),
  AdjustmentsController.getAdjustments,
);
router.post(
  "/adjustments",
  restrictTo(Role.admin, Role.staff),
  AdjustmentsController.createAdjustment,
);
