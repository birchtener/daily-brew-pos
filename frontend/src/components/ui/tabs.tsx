  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-active:bg-primary data-active:text-background hover:data-active:text-background dark:data-active:border-input dark:data-active:bg-foreground dark:data-active:text-card hover:dark:data-active:text-card",
