    ...
    <div className="flex flex-col gap-4">
      {cancelledOrders.length === 0 ? (
        <div className="p-12 text-center text-muted-foreground border border-border bg-card rounded-xl select-none py-16">
          ...
          <div>
            <p className="font-semibold text-foreground text-sm">No cancelled orders found</p>
            <p className="text-xs text-muted-foreground max-w-xs mx-auto mt-1">Once orders are cancelled, their details will be listed here.</p>
          </div>
        </div>
      ) : (
