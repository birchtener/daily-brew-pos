...
export default function DashboardLayout() {
  ...
  const notifications: { id: number; type: string; title: string; message: string; read: boolean }[] = [
        ...
        <header className="sticky top-0 z-20 border-b border-border/60 bg-background/75 backdrop-blur-xl">
            <div className="mx-auto flex items-center justify-between gap-4 px-6 py-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  className="rounded-xl border border-border bg-background px-4 py-2 text-sm font-medium shadow-sm transition hover:bg-muted"
                  >
                  Logout
                  </button>
